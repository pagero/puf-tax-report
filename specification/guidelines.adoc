...
To simplify reporting and standardize the required content, the PUF Tax Report specification has been developed. Currently this specification supports reporting of payments received and payments made.
...
These releases can be followed on https://github.com/pagero/puf-tax-report[GitHub].
...
But we urge all interested parties to follow the project on https://github.com/pagero/puf-tax-report[GitHub] where all releases will be notified.
